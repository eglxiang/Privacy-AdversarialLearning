...
def main():
    anno_file_list = '/home/wuzhenyu_sjtu/DAN_vispr_ucf/vispr/val2017.txt'
    # Load Annotations -------------------------------------------------------------------------------------------------
    ...
    convert_to(np.asarray(images_lst).astype('uint8'), np.asarray(labels_lst).astype('uint8'), name='val_112', directory='/home/wuzhenyu_sjtu/DAN_vispr_ucf/vispr')
