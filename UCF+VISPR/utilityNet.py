...
def C3DNet(videos, _dropout, wd=0.0005):
    ...
    with tf.variable_scope('UtilityModule'):
        ...
        'out': _variable_with_weight_decay('wout', [4096, FLAGS.num_classes_utility], wd)
        }
        biases = {
        ...
        'out': _variable_with_weight_decay('bout', [FLAGS.num_classes_utility], 0.000),
        }
    # Convolution Layer
