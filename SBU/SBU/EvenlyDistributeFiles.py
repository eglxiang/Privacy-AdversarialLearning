...
filenames = []
videos_dir = "/home/wuzhenyu_sjtu/Data_Preparation/SBU_videos/noisy_version/RGB"
nparts=5
...
import shutil
for i in range(nparts):
    newdir = '/home/wuzhenyu_sjtu/Data_Preparation/SBU_videos/noisy_version/part{}'.format(i)
