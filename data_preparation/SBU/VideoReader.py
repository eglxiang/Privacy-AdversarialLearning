...
class SBUReader:
    def __init__(self, depth, sigma=None, ksize=None):
        ...
        self.val_set = set()
        self.test_set = set()
        self.read_val_test_split('/home/wuzhenyu_sjtu/DAN_sbu/SBU/SBU_Kinect/split_hard/val.split', '/home/wuzhenyu_sjtu/DAN_sbu/SBU/SBU_Kinect/split_hard/test.split')
